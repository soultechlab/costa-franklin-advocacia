          ...
          <div className="space-y-8">
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="mt-8 flex gap-4 flex-wrap">
                <a href="https://wa.me/5521964782828" target="_blank" rel="noreferrer" className="pill px-6 py-3 font-semibold transition-all duration-300 flex items-center gap-2" style={{background: 'linear-gradient(135deg, #d2ad36 0%, #c9a332 100%)', color: '#111'}}>
                ...
                <a href="mailto:contato@costafranklinadvogados.com.br" className="pill px-6 py-3 btn-secondary font-semibold flex items-center gap-2">
