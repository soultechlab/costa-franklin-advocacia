          ...
          <div className="space-y-8">
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="https://wa.me/5521964782828" target="_blank" rel="noreferrer" onClick={trackWhatsAppConversion} className="pill px-4 sm:px-6 py-3 font-semibold transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base" style={{background: 'linear-gradient(135deg, #d2ad36 0%, #c9a332 100%)', color: '#111'}}>
