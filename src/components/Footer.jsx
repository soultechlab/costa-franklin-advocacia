      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-12 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-sm text-white">
        <div className="text-center md:text-left">
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-2 sm:gap-3 items-center justify-center md:justify-start">
            <a href="https://wa.me/5521964782828" target="_blank" rel="noreferrer" onClick={trackWhatsAppConversion} className="pill px-3 sm:px-4 py-2 transition-all duration-300 flex items-center gap-2 text-xs sm:text-sm w-full sm:w-auto justify-center" style={{background: 'linear-gradient(135deg, #d2ad36 0%, #c9a332 100%)', color: '#111'}}>
        ...
        <div className="hidden md:block text-center md:text-left">
          ...
          <ul className="space-y-2 text-white/80 text-xs sm:text-sm">
            ...
            <li><a href="https://wa.me/5521964782828" target="_blank" rel="noreferrer" onClick={trackWhatsAppConversion} className="hover:text-white transition">WhatsApp</a></li>
          </ul>
        </div>
        <div className="text-center md:text-left">
