function Footer() {
  ...
  return (
    <footer className="mt-16 brand-border border-t" style={{backgroundColor: '#0f172a'}}>
      <div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-3 gap-8 text-sm text-white">
        <div>
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-semibold text-white">Costa Franklin Advocacia</span>
          </div>
          ...
          <div className="mt-4 flex gap-3">
            <a href="https://wa.me/5521964782828" target="_blank" rel="noreferrer" className="pill px-4 py-2 transition-all duration-300 flex items-center gap-2" style={{background: 'linear-gradient(135deg, #d2ad36 0%, #c9a332 100%)', color: '#111'}}>
            ...
            <a href="mailto:contato@costafranklinadvogados.com.br" className="pill px-4 py-2 text-white hover:opacity-80 transition-all duration-300 flex items-center gap-2" style={{backgroundColor: '#334155'}}>
        ...
        <div>
          <h4 className="font-bold text-lg mb-6 text-[var(--brand-accent)]">Contato Direto</h4>
      ...
      <div className="border-t border-white/20 mt-8 pt-6 pb-4 text-center">
        <p className="text-white">© {currentYear} Costa Franklin Advocacia. Todos os direitos reservados.</p>
      </div>
    </footer>
  )
}
