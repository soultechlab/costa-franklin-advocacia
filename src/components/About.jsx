      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="relative order-1 md:order-1">
            <img
              src="/img/eles.jpg"
              alt="Sócios fundadores do escritório Costa Franklin Advocacia - Advogados especializados em direito civil, trabalhista e empresarial no Rio de Janeiro"
          ...
          <div className="order-2 md:order-2">
            ...
            <h2 className="hidden md:block text-3xl md:text-4xl font-bold leading-tight mb-6">
              Quem <span className="text-[var(--brand-accent)]">Somos</span>
            </h2>
